		...
		<div class="col-sm-6 offset-sm-3">
			<div class="card">
				<div class="card-header">
					<h5 class="text-center"> Kriteria Baru</h5>
				</div>
				<div class="card-body">
...
<script>
	export default {
		...
		methods: {
			...
			store(e) {
				axios.post(window.baseUrl+"/"+e.target.attributes.action.value, this.kriteria).then(response => {
					this.errors = [];
					...
					this.message = 'Kriteria telah ditambahkan.';
